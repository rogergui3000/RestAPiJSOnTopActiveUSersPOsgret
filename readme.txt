...
7. var conString = "postgres://username:password@localhost/database"; with you credential
5. Start the server: `$ node start`
8. Go to -> http://localhost:3000/ to found the first solution for Task 1.
9. navigatave respectiveli to http://localhost:3000/topActiveUsers?page=`number` && http://localhost:3000/users?id=`number` to test res JSOn APi.
...
This comes with unit  test usin mocha and should
